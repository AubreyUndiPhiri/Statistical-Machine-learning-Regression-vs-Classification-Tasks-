---
title: (AUBREY UNDI PHIRI) Statistical Machine Learning 
output:
  pdf_document: 
    fig_caption: true
...
The Bayes optimal classifier is the function that minimizes the theoretical risk. For a given input $x$, it predicts the output $𝑦$ that maximizes the posterior probability
...
cat("Model Robustness: A model’s ability to generalize well to unseen data is an indicator of its robustness.\n")
cat("The Optimal Model’s balanced approach makes it more reliable in real-world scenarios where new, unseen data is expected.\n")
